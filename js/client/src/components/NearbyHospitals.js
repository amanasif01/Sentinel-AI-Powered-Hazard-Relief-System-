...
const NearbyHospitals = ({ onClose, isPage = false, globalLocation }) => {
        ...
        <div className="location-choice-modal" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="location-choice-options">
            ...
            {globalLocation && (
              <>
                <button
                  className="location-choice-btn"
                  onClick={() => handleManualLocation(globalLocation)}
                  style={{ background: 'linear-gradient(135deg, rgba(74, 158, 255, 0.1), rgba(59, 140, 224, 0.2))', border: '1px solid rgba(74, 158, 255, 0.3)' }}
                >
                  <div className="choice-icon" style={{ color: '#4a9eff' }}>
                    <i className="fas fa-crosshairs"></i>
                  </div>
                  <div className="choice-content">
                    <h3 style={{ color: 'white' }}>Use Selected Location</h3>
                    <p>Use "{globalLocation.name}" from your previous search</p>
                  </div>
                </button>
                <div className="choice-divider">
                  <span>OR</span>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="hospital-actions">
                        <a
                          href={`https://www.google.com/maps/dir/?api=1&destination=${hospital.latitude},${hospital.longitude}${(currentLocation || selectedLocation) ? `&origin=${(currentLocation || selectedLocation).lat || (currentLocation || selectedLocation).latitude},${(currentLocation || selectedLocation).lon || (currentLocation || selectedLocation).longitude}` : ''}`}
                          target="_blank"
