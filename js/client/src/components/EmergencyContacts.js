      ...
      <div className={isPage ? 'emergency-contacts-container page' : 'emergency-contacts-container'}>
        ...
        <div className="emergency-contacts-content">
          ...
          {activeTab === 'services' && (
            <div className="tab-content">
              <div className="status-management">
                <h3>Pakistan Emergency Services</h3>
                <p className="section-description">
                  Quick access to national emergency contact numbers in Pakistan.
                </p>
                <div className="services-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: '20px', marginTop: '20px' }}>
                  {[
                    { name: 'Police Helpline', number: '15', icon: 'fa-shield-alt', color: '#1565c0' },
                    { name: 'Edhi Ambulance', number: '115', icon: 'fa-ambulance', color: '#d32f2f' },
                    { name: 'Rescue 1122 (Punjab/KP/Sindh)', number: '1122', icon: 'fa-briefcase-medical', color: '#e53935' },
                    { name: 'Fire Brigade', number: '16', icon: 'fa-fire-extinguisher', color: '#ff8f00' },
                    { name: 'Motorway Police', number: '130', icon: 'fa-car', color: '#2e7d32' },
                    { name: 'Aman Ambulance', number: '1021', icon: 'fa-heartbeat', color: '#c62828' },
                    { name: 'Chhipa Ambulance', number: '1020', icon: 'fa-medkit', color: '#00838f' },
                    { name: 'Rangers Helpline', number: '1101', icon: 'fa-user-shield', color: '#37474f' }
                  ].map((service, idx) => (
                    <div key={idx} style={{
                    ...
                    >
                      <div style={{
                        width: '50px', height: '50px', borderRadius: '50%', background: `${service.color}22`,
                        display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.5rem', color: service.color
                      }}>
                        <i className={`fas ${service.icon}`}></i>
                      </div>
                      <div>
                        <div style={{ fontSize: '0.9rem', color: 'rgba(255,255,255,0.7)', marginBottom: '5px' }}>{service.name}</div>
                        <div style={{ fontSize: '1.5rem', fontWeight: 'bold' }}>
                          <span style={{ color: 'var(--light)' }}>{service.number}</span>
                        </div>
                      </div>
                    </div>
                  ))}
