...
const DisasterKitRecommender = ({ selectedLocation, onLocationSelect, onBack, globalLocation }) => {
                ...
                <div className="search-section-container">
                    ...
                    {globalLocation && (
                        <div style={{ marginBottom: '20px', textAlign: 'center' }}>
                            <button
                                onClick={() => onLocationSelect(globalLocation)}
                                style={{
                                    padding: '12px 24px',
                                    background: 'linear-gradient(135deg, #4a9eff, #3b8ce0)',
                                    color: 'white',
                                    border: 'none',
                                    borderRadius: '12px',
                                    fontWeight: 'bold',
                            ...
                            >
                                ...
                                Use Selected Location: {globalLocation.name}
                            </button>

                            <div style={{ margin: '15px 0', color: 'rgba(255,255,255,0.5)', fontSize: '0.9rem', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                <span style={{ flex: 1, height: '1px', background: 'rgba(255,255,255,0.1)', margin: '0 10px' }}></span>
